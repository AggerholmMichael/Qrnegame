...
level_cd = str(cur_dir + "\\lvls")
coords_cd = str(cur_dir + "\\coords")
...
lost_screen = pygame.image.load(str(cur_dir + "\\lost_screen.png"))
...
def get_goal():
    ...
    try:
        ...
        for i in goal:
            ...
            if i > 1 and "player_pos" not in i:
...
def load_level():
    ...
    player.rect.y = p_pos[1]
    player.rect.x = p_pos[2]
